 ...
 * Banners Model
 *
 * @property \App\Model\Table\MidiasTable|\Cake\ORM\Association\BelongsTo $Midias
 *
...
class BannersTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('nome_banner')
            ->maxLength('nome_banner', 200)
            ->requirePresence('nome_banner', 'create')
            ->allowEmptyString('nome_banner', false);
