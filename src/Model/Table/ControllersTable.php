...
class ControllersTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setDisplayField('nome_controlador');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('nome_controlador')
            ->maxLength('nome_controlador', 300)
            ->requirePresence('nome_controlador', 'create')
            ->allowEmptyString('nome_controlador', false)
            ->add('nome_controlador', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
    ...
    {
        $rules->add($rules->isUnique(['nome_controlador']));
