...
<div style="margin-top: 67px;" class="col-sm-12">
            ...
            <div class="col-sm-6">
                <div class="alert alert-info">
                    ...
                    <fieldset>
                        <legend></legend>
                        <br>
                        <a style="margin-bottom: 2px;" href="/enderecos/excluir-endereco-cliente/<?= $endereco->id ?>"
                           class="btn btn-sm btn-danger"><i class="far fa-trash-alt"></i> Excluir</a>
                        <a style="margin-bottom: 2px;" href="/enderecos/editar-endereco-cliente/<?= $endereco->id ?>"
    ...
    <?php
    if ($enderecosCount == 0) {
        echo '<div style="text-align: center" class="alert alert-danger">Você ainda não possui endereços cadastrados, por favor adicione pelo menos um...</div>';
    }
    ?>
</div>