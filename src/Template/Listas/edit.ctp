 ...
 */
$adicionaisJson = json_encode($lista->adicionais);
?>
    <div class="col-sm-12">
        <?= $this->Form->create($lista) ?>
        <fieldset>
            <legend><?= __('Editar Lista') ?></legend>
        </fieldset>
        <div class="tab">
        ...
        <div id="adicionais" style="height: 550px" class="tabcontent">
            <div ng-app="web-app">
                ...
                <ui-grid-form list='<?= $adicionaisJson ?>' ng-model="adicionais" title="Adicionais da lista"></ui-grid-form>
            </div>
        </div>
        <br/>
        <br/>
