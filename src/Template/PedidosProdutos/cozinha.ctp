<div class="col-sm-12">
    ...
    $dataGrid->addField('#Pedido', 'pedido_id', \App\Model\Utils\DataGridLaDev::TYPE_TEXT);
    $dataGrid->addField('Tipo Pedido', 'pedido/tipo_pedido', \App\Model\Utils\DataGridLaDev::TYPE_LIST , \App\Model\Entity\Pedido::getTipoList());
    $dataGrid->addField('Produto', 'produto/nome_produto', \App\Model\Utils\DataGridLaDev::TYPE_TEXT);
    $dataGrid->addField('Quantidade', 'quantidade', \App\Model\Utils\DataGridLaDev::TYPE_NUMBER);
    $dataGrid->addField('Valor Cobrado', 'valor_total_cobrado', \App\Model\Utils\DataGridLaDev::TYPE_NUMBER);
    $dataGrid->addField('OBS.', 'observacao', \App\Model\Utils\DataGridLaDev::TYPE_TEXT);
    $dataGrid->addField('Status', 'status', \App\Model\Utils\DataGridLaDev::TYPE_LIST, \App\Model\Entity\PedidosProduto::getStatusList());
