...
<div class="col-sm-12">
    ...
    $dataGrid->addAction('PerfilsActions', 'index', 'Perfil x Action','btn btn-success', 'fas fa-charging-station');
    $dataGrid->addAction('PerfilsUsers', 'index', 'Perfil x User','btn btn-info', 'fas fa-address-card');
